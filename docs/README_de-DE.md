...
- **--repo-url**: Das benutzerdefinierte Repository von Bedrock Chat für die Bereitstellung, falls geforkt oder mit benutzerdefinierten Quellcode. (Standard: https://github.com/LinksysJimmy/laila-chat.git)
