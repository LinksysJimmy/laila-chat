...
- **--repo-url**: Det tilpassede repoet for Bedrock Chat som skal distribueres, hvis forket eller tilpasset kildekontroll. (standard: https://github.com/LinksysJimmy/laila-chat.git)
